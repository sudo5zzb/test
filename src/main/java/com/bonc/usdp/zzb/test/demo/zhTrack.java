...
//        ESManager.es_ip = "127.0.0.1";
        ...
        ESManager.socket_port=3300;
        ESManager.http_port=3200;
...
//        ESManager.http_port=8200;
        ...
        String filePath = "C:\\Users\\zzb\\Desktop\\北京展会\\tracks.xlsx";
        List<List<String>> lists = handler.readExcelByRows(filePath, 0, 0, 1, -1, 0, -1);
        QueryRunner runner = ESManager.getInstance().getQueryRunner("zh_track");
        ...
        for (List<String> row : lists) {
            ...
            try {
                ESManager.getInstance().getSearchService().upsertByJson("zh_track", "TRACK", UUID.randomUUID().toString(), track.toJSONString());
    ...
    private static String getId(String name) {
        ...
        QueryRunner runner = ESManager.getInstance().getQueryRunner("zh_person");
